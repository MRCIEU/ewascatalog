...
-- Create user
CREATE USER IF NOT EXISTS '${DATABASE_USER}'@'${DATABASE_HOST}' IDENTIFIED BY '${DATABASE_PASSWORD}';
...
LOAD DATA LOCAL INFILE '/data/inputs/cpg_annotation.txt'
INTO TABLE cpgs
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
...
LOAD DATA LOCAL INFILE '/data/inputs/gene_annotation.txt'
INTO TABLE genes
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
